  ...
  return (
    <div className="legal-page">
      <div className="legal-card">
        ...
        <h2>4. Max Subscriptions &amp; Payments</h2>
        <p>Max content/features are activated through a manual process, not an automatic payment gateway:</p>
        <ul>
          ...
          <li>Once approved, you'll receive a one-time activation code to redeem in the app, unlocking Max for the duration you paid for.</li>
        ...
        <ul>
          <li>Max is a one-time payment for a fixed duration, not an auto-renewing subscription - there's nothing to "cancel" in that sense.</li>
